...
const Import = () => {
    ...
    return (
        <div className="lg:w-1/2 xl:w-5/12 p-6 sm:p-12">
            ...
            <div className="mt-10">
                <button onClick={handleUpload} disabled={loading} type="button" className="py-2 px-4 flex justify-center items-center  bg-blue-600 hover:bg-blue-700 focus:ring-blue-500 focus:ring-offset-blue-200 text-white w-full transition ease-in duration-200 text-center text-base font-semibold shadow-md focus:outline-none focus:ring-2 focus:ring-offset-2  rounded-lg max-w-md">
                    {loading ? <div className='flex'><svg width="20" height="20" fill="currentColor" className="mr-2 animate-spin" viewBox="0 0 1792 1792" xmlns="http://www.w3.org/2000/svg">
